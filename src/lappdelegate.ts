...
export class LAppDelegate {
  ...
  public initialize(): boolean {
    ...
    // 切换模型，在需要切换模型的html元素上添加 id="live2dChangeModel"
    const changeModel = <HTMLSpanElement>document.getElementById('live2dChangeModel')
    ...
    if (!gl) {
      alert(
        'Cannot initialize WebGL. This browser does not support.\n不能初始化WebGL，该浏览器不支持WebGL，请切换浏览器重试'
      )
      gl = null
